 ...
 */
export function filterHTMLAttribute<T>(props: AllHTMLAttributes<HTMLElement> & T) {
  const result = { ...props };
...
export function filterHTMLDataAttribute<T>(props: AllHTMLAttributes<HTMLElement> & T) {
  const result = { ...props };
